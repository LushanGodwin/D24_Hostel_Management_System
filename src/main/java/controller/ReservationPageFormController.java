...
public class ReservationPageFormController implements Initializable {
    ...
    ReservationBO<ReservationDTO> reservationBO = (ReservationBO<ReservationDTO>) BOFactory.getBoFactory().getBO(BOFactory.BOTypes.RESERVATION);
    ...
    private void getAllRooms() {
        ...
        if (!(allRooms.isEmpty())) {
            ...
            for (RoomDTO roomDTO : allRooms) {
                ...
                obListRoom.add(new RoomTM(roomDTO.getRoom_type_id(),
